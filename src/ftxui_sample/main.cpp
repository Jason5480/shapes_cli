...
// configuration step. It creates a namespace called `shapes_cli`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", shapes_cli::cmake::project_name, shapes_cli::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", shapes_cli::cmake::project_version);
      return EXIT_SUCCESS;
    }
